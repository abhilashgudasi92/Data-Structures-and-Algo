...
public class TripletSum {
	...
	// sum equal to a given number
	   ...
	   boolean isSumSorted(TripletSum la, TripletSum lb, TripletSum lc,
	                       int givenNumber)
	   {
	      Node a = la.head;
	    ...
	    {
	    	TripletSum llist1 = new TripletSum();
	        ...
	        /*create a sorted linked list 'b' 2->4->9->10 		Ascending(Merge Sort)*/
	        llist2.push(10);
	        llist2.push(9);
	        llist2.push(4);
	        llist2.push(2);
	 
	        /*create another sorted linked list 'c' 8->4->2->1 	Descending(Merge Sort)*/		
	        llist3.push(1);
	        llist3.push(2);
	        llist3.push(4);
	        llist3.push(8);
